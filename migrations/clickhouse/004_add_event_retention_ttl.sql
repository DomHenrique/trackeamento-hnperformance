...
ALTER TABLE tracking_events.events MODIFY TTL toDateTime(event_time) + INTERVAL 90 DAY;

-- Se a tabela de migração events_v2 existir, aplica a mesma cláusula de expurgo
-- ALTER TABLE tracking_events.events_v2 MODIFY TTL toDateTime(event_time) + INTERVAL 90 DAY;
